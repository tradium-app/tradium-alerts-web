...
const HomePage = ({ authUser }) => {
    ...
    const tableInstance = useTable({ columns, data: watchList })
        ...
        <div className="page-content bg-white">
            ...
            <Container fluid>
                <div className="table-responsive">
                    <Table className="table-centered table-nowrap" {...getTableProps()}>
                        <thead>
