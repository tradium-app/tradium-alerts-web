                                            ...
                                            <div className="mt-4 mt-xl-3">
                                                ...
                                                <Row className="mb-3">
                                                    <Col md="6">
                                                        <div>
                                                            <p className="text-muted">
                                                                <i className="bx bx-unlink font-size-16 align-middle text-primary mr-1"></i> Wireless
                                                            </p>
                                                            <p className="text-muted">
                                                            ...
                                                            <p className="text-muted">
                                                                <i className="bx bx-battery font-size-16 align-middle text-primary mr-1"></i> Battery
                                                                life : 6hrs
                                                            </p>
                                                        </div>
                                                    </Col>
                                                    <Col md="6">
                                                        <div>
                                                            <p className="text-muted">
                                                                <i className="bx bx-user-voice font-size-16 align-middle text-primary mr-1"></i> Bass
                                                            </p>
                                                            <p className="text-muted">
                                                                <i className="bx bx-cog font-size-16 align-middle text-primary mr-1"></i> Warranty : 1
                                                                Year
                                                            </p>
                                                        </div>
                                                    </Col>
                                            ...
                                            <Media className={comment.id === 1 ? 'border-bottom' : 'border-bottom mt-3'} key={'__media__' + k}>
                                                ...
                                                <Media body>
                                                    ...
                                                    <ul className="list-inline float-sm-right">
                                                        ...
                                                        <li className="list-inline-item">
                                                            <Link to="#">
                                                                <i className="far fa-comment-dots mr-1"></i> Comment
                                                            </Link>
                                                        </li>
                                                    </ul>
