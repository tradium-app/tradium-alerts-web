...
class CryptoWallet extends Component {
    constructor(props) {
        ...
        this.state = {
            series: [
                { type: 'area', name: 'BTC', data: [87, 57, 74, 99, 75, 38, 62, 47, 82, 56, 45, 47] },
                { type: 'area', name: 'ETH', data: [28, 41, 52, 42, 13, 18, 29, 18, 36, 51, 55, 35] },
                                        ...
                                        <Row>
                                            ...
                                            <Col sm="6">
                                                <div className="text-sm-right mt-4 mt-sm-0">
                                                    ...
                                                    <h5>
                                                        + $ 248.35 <span className="badge badge-success ml-1 align-bottom">+ 1.3 %</span>
                                                    </h5>
                                                </div>
                                            </Col>
                                        </Row>
