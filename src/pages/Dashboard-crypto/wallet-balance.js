                    ...
                    <CardBody>
                        ...
                        <Row>
                            <Col lg="4">
                                <div className="mt-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        {' '}
                                        + 0.0012.23 ( 0.2 % ) <i className="mdi mdi-arrow-up ml-1 text-success"></i>
                                    </p>
                            ...
                            <Col lg="4" sm="6" className="align-self-center">
                                <div>
                                    <p className="mb-2">
                                        <i className="mdi mdi-circle align-middle font-size-10 mr-2 text-primary"></i> Ethereum
                                    </p>
                                    <h5>
                                ...
                                <div className="mt-4 pt-2">
                                    <p className="mb-2">
                                        <i className="mdi mdi-circle align-middle font-size-10 mr-2 text-warning"></i> Bitcoin
                                    </p>
                                    <h5>
                                ...
                                <div className="mt-4 pt-2">
                                    <p className="mb-2">
                                        <i className="mdi mdi-circle align-middle font-size-10 mr-2 text-info"></i> Litecoin
                                    </p>
                                    <h5>
