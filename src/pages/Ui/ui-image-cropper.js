...
import { Card, Row, Col, CardBody, Modal, ModalHeader, ModalBody, ModalFooter, Button, Label, UncontrolledTooltip, ButtonGroup } from 'reactstrap'
                                                ...
                                                <div className="docs-toggles">
                                                    <div className="img-crop-preview-toggles mt-4 mt-xl-2">
                                                        <div className="btn-group d-flex flex-nowrap" data-toggle="buttons">
                                                            <Label
                                                                className={
                                                                    this.state.ratio1 === 16 && this.state.ratio2 === 9
                                                            ...
                                                            <Label
                                                                className={
                                                                    this.state.ratio1 === 4 && this.state.ratio2 === 3
                                                                        ? 'btn btn-primary active'
                                                                        : 'btn btn-primary'
                                                                }
                                                            >
                                                            ...
                                                            <Label
                                                                className={
                                                                    this.state.ratio1 === 1 && this.state.ratio2 === 1
                                                                        ? 'btn btn-primary active'
                                                                        : 'btn btn-primary'
                                                                }
                                                            >
                                                            ...
                                                            <Label
                                                                className={
                                                                    this.state.ratio1 === 2 && this.state.ratio2 === 3
                                                                        ? 'btn btn-primary active'
                                                                        : 'btn btn-primary'
                                                                }
                                                            >
                                                            ...
                                                            <Label
                                                                className={
                                                                    this.state.ratio1 === '' && this.state.ratio2 === ''
                                                                        ? 'btn btn-primary active'
                                                                        : 'btn btn-primary'
                                                                }
                                                            >
                                                ...
                                                <div className="button-items mt-2">
                                                    ...
                                                    <ButtonGroup>
                                                        <Button
                                                            type="button"
                                                            color="primary"
                                                            onClick={() => this.setState({ zoom: this.state.zoom + 0.1 })}
                                                        >
                                                    ...
                                                    <ButtonGroup>
                                                        <Button
                                                            type="button"
                                                            color="primary"
                                                            onClick={() => this.setState({ rotate: this.state.rotate - 45 })}
                                                            title="Rotate Left"
                                                        >
                                                    ...
                                                    <ButtonGroup>
                                                        <Button
                                                            type="button"
                                                            color="primary"
                                                            onClick={() => this.setState({ enable: false, disable: true })}
                                                            title="Disable"
                                                        >
                                                        ...
                                                        <Button
                                                            type="button"
                                                            color="primary"
                                                            onClick={() => this.setState({ enable: true, disable: false })}
                                                            title="Enable"
                                                        >
