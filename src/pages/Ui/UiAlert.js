                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Alerts are available for any length of text, as well as an optional dismiss button. For proper styling, for
                                        Example, <strong>color = </strong> <code className="highlighter-rouge">"success"</code>
                                    </CardSubtitle>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Use the <code className="highlighter-rouge">.alert-link</code> utility className to quickly provide matching
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">You can see this in action with a live demo:</CardSubtitle>
