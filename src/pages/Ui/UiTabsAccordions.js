                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        ...
                                        <code className="highlighter-rouge">bootstrap.js</code> file—to extend our navigational tabs and pills to
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Use the tab JavaScript plugin—include it individually or through the compiled{' '}
                                        <code className="highlighter-rouge">bootstrap.js</code> file—to extend our navigational tabs and pills to
                                        createtabbable panes of local content, even via dropdown menus.
                                    </CardSubtitle>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">Extend the default collapse behavior to create an accordion.</CardSubtitle>
