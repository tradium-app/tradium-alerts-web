                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Any single <code className="highlighter-rouge">.btn</code> can be turned into a dropdown toggle with some
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Trigger dropdown menus above elements by adding <code className="highlighter-rouge">.dropup</code> to the
                                        parent element.
                                    </CardSubtitle>
                                    <div className="d-flex">
                                        <Dropdown isOpen={dropup1} direction="up" toggle={() => setDropup1(!dropup1)}>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        &nbsp;
                                        <ButtonDropdown direction="left" isOpen={infodrp_up1111} toggle={() => setInfodrp_up1111(!infodrp_up1111)}>
                                            <DropdownToggle caret color="info">
