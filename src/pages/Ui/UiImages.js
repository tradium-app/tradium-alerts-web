                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Use classNamees <code>.rounded</code> and <code>.rounded-circle</code>.
                                    </CardSubtitle>
                                    <Row>
                                        <Col md={6}>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        ...
                                        <code className="highlighter-rouge">height: auto;</code> are applied to the image so that it scales with the
                                        parent element.
                                    </CardSubtitle>
