                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="">
                                        <Progress className="mb-2" value={25} color="primary" style={{ height: '3px' }}></Progress>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        The striped gradient can also be animated. Add <code className="highlighter-rouge"> striped animated </code>{' '}
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Add <code className="highlighter-rouge"> striped </code> to any to apply a stripe via CSS gradient over the
