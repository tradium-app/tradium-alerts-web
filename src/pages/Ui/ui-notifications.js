                                            ...
                                            <div className="control-group my-4">
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="closeButton">
                                                        Close Button
                                                    </Label>
                                                </div>
                                                ...
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="debugInfo">
                                                        Debug
                                                    </Label>
                                                </div>
                                                ...
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="progressBar">
                                                        Progress Bar
                                                    </Label>
                                                </div>
                                                ...
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="preventDuplicates">
                                                        Prevent Duplicates
                                                    </Label>
                                                </div>
                                                ...
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="addClear">
                                                ...
                                                <div className="custom-control custom-checkbox mb-2">
                                                    <input
                                                        ...
                                                        value="checked"
                                                    />
                                                    <Label className="custom-control-label" for="newestOnTop">
                                                        Newest on top
                                                    </Label>
                                                </div>
                                            </div>
                                                ...
                                                <div className="controls mb-4">
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        <input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="custom-control-label" for="radio1">
                                                            Success
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        <input
                                                            ...
                                                            value="info"
                                                        />
                                                        <Label className="custom-control-label" for="radio2">
                                                            Info
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        <input
                                                            ...
                                                            value="warning"
                                                        />
                                                        <Label className="custom-control-label" for="radio3">
                                                            Warning
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        <input
                                                            ...
                                                            value="error"
                                                        />
                                                        <Label className="custom-control-label" for="radio4">
                                                            Error
                                                        </Label>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="control-group" id="positionGroup">
                                                <div className="controls mb-4">
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio5">
                                                            Top Right
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio6">
                                                            Bottom Right
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio7">
                                                            Bottom Left
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio8">
                                                            Top Left
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio9">
                                                            Top Full Width
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio10">
                                                            Bottom Full Width
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio11">
                                                            Top Center
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="custom-control custom-radio mb-2">
                                                        ...
                                                        />
                                                        <Label className="custom-control-label" for="radio12">
                                                            Bottom Center
                                                        </Label>
                                                    </div>
                                                </div>
