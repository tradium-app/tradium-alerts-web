                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Add one another property like <code className="highlighter-rouge">outline</code> ones to remove all background
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        ...
                                        However, you can also use these classes on <code className="highlighter-rouge">&lt;Link&gt;</code> or{' '}
                                        <code className="highlighter-rouge">&lt;input&gt;</code> elements (though some browsers may apply a slightly
                                        different rendering).
                                    </CardSubtitle>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="button-items">
                                        <Button color="primary" className="btn btn-primary btn-lg btn-block waves-effect waves-light">
                                            Block level button
                                        </Button>
                                        <Button color="secondary" className="btn btn-secondary btn-sm btn-block waves-effect">
                                            Block level button
                                        </Button>
                                    </div>
                                </CardBody>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        ...
                                        toggling. Add <code className="highlighter-rouge">data-toggle="buttons"</code> to a
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={6}>
                                            <div className="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label className={radio1 ? 'btn btn-primary active' : 'btn btn-primary'}>
                                                    <input
                                                        type="radio"
                                                        name="options"
                                                        id="option1"
                                                ...
                                                <label className={radio2 ? 'btn btn-primary active' : 'btn btn-primary'}>
                                                    <input
                                                        type="radio"
                                                        name="options"
                                                        id="option2"
                                                ...
                                                <label className={radio3 ? 'btn btn-primary active' : 'btn btn-primary'}>
                                                    <input
                                                        type="radio"
                                                        name="options"
                                                        id="option3"
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Combine sets of button groups into button toolbars for more complex components. Use utility classNamees as
