                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">
                                        Provide valuable, actionable feedback to your users with HTML5 form validation–available in all our supported
                                        browsers.
                                    </p>
                        ...
                        <Col xl="6">
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">
                                        If your form layout allows it, you can swap the <code>.-feedback</code> classes for <code>.-tooltip</code>{' '}
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Parsley is a availity reactstrap validation. It helps you provide your users with feedback on their form
                                ...
                                <CardBody>
                                    ...
                                    <AvForm>
                                        ...
                                        <AvField
                                            ...
                                            validate={{ required: { value: true }, minLength: { value: 5 }, maxLength: { value: 10 } }}
                                        />
                                        <AvField
                                            name="Regular_Exp"
                                            label="Regular Exp  "
