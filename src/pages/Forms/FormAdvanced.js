                                ...
                                <CardBody>
                                    ...
                                    <Form action="#">
                                        ...
                                        <FormGroup>
                                            ...
                                            />
                                            {display_RGBA ? (
                                                <SketchPicker color="#fff" value={colorRGBA} width="160px" onChangeComplete={onSwatchHover_RGBA} />
                                            ) : null}
                                        </FormGroup>
                                ...
                                <CardBody>
                                    ...
                                    <Form>
                                        <FormGroup className="mb-4">
                                            ...
                                            <InputGroup>
                                                <DatePicker className="form-control" selected={default_date} onChange={handleDefault} />
                                            </InputGroup>
                                        </FormGroup>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">
                                        This plugin integrates by default with Twitter bootstrap using badges to display the maximum lenght of the
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-muted m-b-15">
                                            All you need to do is specify the <code>placement</code> option, with one of those strings. If none is
                                            specified, the positioning will be defauted to 'bottom'.
                                        </p>
                                        <Input
                                            type="text"
                                            maxLength="25"
