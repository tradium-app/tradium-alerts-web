                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Here are examples of <code>.form-control</code> applied to each textual HTML5 <code>&lt;input&gt;</code>{' '}
                                        <code>type</code>.
                                    </CardSubtitle>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        Set heights using classNamees like <code>.form-control-lg</code> and <code>.form-control-sm</code>.
                                    </CardSubtitle>
                                    <div>
                                        <div className="mb-4">
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <CardSubtitle className="mb-3">
                                        ...
                                        up with functional <em>Choose file…</em> and selected file name text.
                                    </CardSubtitle>
