                ...
                <Card>
                    <CardBody>
                        <Row>
                                ...
                                <div className="text-lg-center">
                                    {props.data.image !== 'Null' ? (
                                        ...
                                        <div className="avatar-sm mr-3 mx-lg-auto mb-4 float-left float-lg-none">
                                            <span
                                                className={'avatar-title rounded-circle bg-soft-' + props.data.color + ' text-primary font-size-16'}
                                            >
                                                {nameIcon}
                                            </span>
                                        </div>
                            ...
                            <Col lg="8">
                                <div>
                                    <Link to="/invoices-detail" className="d-block text-primary mb-2">
                                    ...
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item mr-3">
                                            <h5 className="font-size-14" id="amountTooltip">
                                                <i className="bx bx-money mr-1 text-primary"></i>$ {props.data.invoicePrice}
