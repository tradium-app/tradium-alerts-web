const IndicatorValues = [
    {
        ...
        text: 'RSI',
        values: [
            { value: 'overbought_60', valueText: 'Over 60', valueConfig: { length: 14, value: 60, upDirection: true } },
            { value: 'overbought_70', valueText: 'Over 70', valueConfig: { length: 14, value: 70, upDirection: true } },
            { value: 'overbought_80', valueText: 'Over 80', valueConfig: { length: 14, value: 80, upDirection: true } },
            { value: 'overbought_90', valueText: 'Over 90', valueConfig: { length: 14, value: 90, upDirection: true } },
            { value: 'oversold_40', valueText: 'Under 40', valueConfig: { length: 14, value: 40, upDirection: false } },
            { value: 'oversold_30', valueText: 'Under 30', valueConfig: { length: 14, value: 30, upDirection: false } },
            { value: 'oversold_20', valueText: 'Under 20', valueConfig: { length: 14, value: 20, upDirection: false } },
            { value: 'oversold_10', valueText: 'Under 10', valueConfig: { length: 14, value: 10, upDirection: false } },
        ],
    },
    {
        name: 'sma',
